...
static constexpr auto qt_meta_stringdata_ZN13cancontrollerE = QtMocHelpers::stringData(
    "cancontroller",
    "sentTempDriver",
    "",
    "val",
...
Q_CONSTINIT static const uint qt_meta_data_ZN13cancontrollerE[] = {
...
Q_CONSTINIT const QMetaObject cancontroller::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13cancontrollerE.offsetsAndSizes,
    qt_meta_data_ZN13cancontrollerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13cancontrollerE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<cancontroller, std::true_type>,
...
void *cancontroller::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13cancontrollerE.stringdata0))
