...
static constexpr auto qt_meta_stringdata_ZN10AudioVolumE = QtMocHelpers::stringData(
    "AudioVolum",
    "volumLevelChanged",
    "",
    "setVolumLevel",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10AudioVolumE[] = {
...
Q_CONSTINIT const QMetaObject AudioVolum::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10AudioVolumE.offsetsAndSizes,
    qt_meta_data_ZN10AudioVolumE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10AudioVolumE_t,
        // property 'volumLevel'
        QtPrivate::TypeAndForceComplete<int, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<AudioVolum, std::true_type>,
...
void AudioVolum::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (AudioVolum::*)();
            if (_q_method_type _q_method = &AudioVolum::volumLevelChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *AudioVolum::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10AudioVolumE.stringdata0))
